...
public class PlatformAlreadyExistsException extends Exception {
     ...
     * 
     */
    private static final long serialVersionUID = 742708544021049989L;
     ...
     */
    public PlatformAlreadyExistsException(final String message, final Throwable cause) {
        super(message, cause);
    }
     ...
     *            cause of the exception
     */
    public PlatformAlreadyExistsException(final Throwable cause) {
        super(cause);
    }
