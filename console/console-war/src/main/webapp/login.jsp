...
<%
    ...
    // Build Action URL
    final String tenantId = org.apache.commons.lang.StringEscapeUtils.escapeHtml(JSP.getParameter("tenant"));
			...
			<form id="LoginForm" action="<%=actionUrl%>" method="post">
				...
				<div class="formentries">
					<div class="formentry" title="<%=i18n._("Enter your login (username)")%>">
						...
						<div class="input">
							<input title="<%=i18n._("Username")%>" id="username" name="username" value="<%= org.apache.commons.lang.StringEscapeUtils.escapeHtml(JSP.getSessionOrCookie("username", "")) %>" placeholder="<%=i18n._("User")%>" type="text" tabindex="1" maxlength="50" <%=disableLogin ? "disabled=\"disabled\" " : ""%> />
						</div>
					</div>
