 ...
 * @author Julien Mege
 */
public class GroupQuickDetailsPage extends ItemQuickDetailsPage<GroupItem> {

    public static final String TOKEN = "groupquickdetails";

    public GroupQuickDetailsPage() {
    ...
    @Override
    protected LinkedList<ItemDetailsAction> defineActions(final GroupItem item) {
        return null;
    }
