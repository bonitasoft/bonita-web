...
public class MenuNameAttributeReader extends AbstractAttributeReader implements HasDeploys {
    private String attributeToDeploy;

    /**
     * Default Constructor.
     * @param attributeToRead
     */
    public MenuNameAttributeReader(String attributeToDeploy, String attributeToRead) {
    ...
    protected String _read(IItem item) {
        ...
        if (item.getAttributeValue(attributeToDeploy).equals("0")) {
            ...
            IItem deployedItem = item.getDeploy(attributeToDeploy);
