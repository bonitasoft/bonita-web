...
public class AppResourceFilter extends ItemListingResourceFilter {
    ...
    public AppResourceFilter(String... tablesToDisplay) {
        super(new APISearchRequest(ProcessDefinition.get()), ProcessItem.ATTRIBUTE_DISPLAY_NAME, ProcessItem.ATTRIBUTE_ICON, tablesToDisplay);
    }

    public AppResourceFilter(APISearchRequest apiSearchRequest, String... tablesToDisplay) {
        super(apiSearchRequest, ProcessItem.ATTRIBUTE_DISPLAY_NAME, ProcessItem.ATTRIBUTE_ICON, tablesToDisplay);
    }
}
