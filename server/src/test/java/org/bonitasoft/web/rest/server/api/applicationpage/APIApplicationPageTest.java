...
public class APIApplicationPageTest {
    ...
    public void search_should_return_the_result_of_dataStore_search() throws Exception {
        ...
        given(applicationPageDataStore.search(0, 10, "request", "default", Collections.singletonMap("token", "page"))).willReturn(result);

        //when
        final ItemSearchResult<ApplicationPageItem> retrievedResult = apiApplicationPage.search(0, 10, "request", "default",
