...
public class ArchivedCaseContextResourceTest extends RestletTest{
    ...
    public void should_getTaskIDParameter_throws_an_exception_when_archived_case_id_parameter_is_null() throws Exception {
        ...
        try {
            ...
            Assertions.assertThat(e.getMessage()).isEqualTo("Attribute '" + ArchivedCaseContextResource.ARCHIVED_CASE_ID + "' is mandatory in order to get the archived case context");
        }

    }

    @Test
    public void should_respond_404_Not_found_when_archived_case_is_not_found_when_getting_the_context() throws Exception {
        when(processAPI.getArchivedProcessInstanceExecutionContext(2)).thenThrow(new ProcessInstanceNotFoundException("case 2 not found"));
