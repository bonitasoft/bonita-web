...
public class DocumentDatastoreTest extends APITestWithMock {
     ...
     * // ---------- ADD METHOD TESTS ------------------------------//
     * @Test
     * public void it_should_add_a_document_calling_addDocument() throws Exception {
     * // Given
     ...
     * verify(processAPI).addDocument(equals(1L), "doc 1", "", any(DocumentValue.class));
     ...
     * @Test
     * public void it_should_call_processAPI_attachDocument_method_with_document_content() throws Exception, DocumentAttachmentException,
     ...
     * // Then
     * verify(processAPI).addDocument(1l, "Doc 1", "doc.jpg", "image/jpeg", DocumentUtil.getArrayByteFromFile(new File(docUrl.getPath())), null);
     * }
     * @Test
     ...
     * // Then
     * verify(processAPI).addDocument(1l, "Doc 1", "doc.jpg", "image/jpeg", "http://images/doc.jpg", null);
     * }
     * @Test
