...
public class TaskExecutionResourceTest extends RestletTest {
    ...
    public void should_execute_a_task_with_given_inputs() throws Exception {
        ...
        final Response response = request("/bpm/tasks/2/execution").post(VALID_COMPLEX_POST_BODY);
    ...
    public void should_respond_400_Bad_request_when_contract_is_not_validated_when_executing_a_task() throws Exception {
        ...
        final Response response = request("/bpm/tasks/2/execution").post(VALID_POST_BODY);
    ...
    public void should_respond_400_Bad_request_when_trying_to_execute_with_not_json_payload() throws Exception {
        final Response response = request("/bpm/tasks/2/execution").post("invalid json string");
