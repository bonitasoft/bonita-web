...
public class ArchivedActivityDatastoreTest {
    ...
    public void should_return_ArchivedFlowNodeItem() throws Exception {
        ...
        ArchivedActivityDatastore abstractArchivedActivityDatastore = spy(new ArchivedActivityDatastore(null, ArchivedActivityDefinition.TOKEN));

        doReturn(processAPI).when(abstractArchivedActivityDatastore).getProcessAPI();
        doReturn(new ArchivedCallActivityInstanceImpl("test")).when(processAPI).getArchivedActivityInstance(id.toLong());
    ...
    public void should_thrown_APIItemNotFoundException_when_ArchiveActivityInstance_not_exists() throws Exception {
        APIID id = APIID.makeAPIID(1L);
        ArchivedActivityDatastore archivedActivityDatastore = spy(new ArchivedActivityDatastore(null, ArchivedActivityDefinition.TOKEN));
        ...
        APIItemNotFoundException apiException = assertThrows(APIItemNotFoundException.class, () -> archivedActivityDatastore.get(id));
