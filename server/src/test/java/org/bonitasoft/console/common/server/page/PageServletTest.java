...
public class PageServletTest {
    ...
    public void should_get_server_error_when_issue_with_customPage() throws Exception {
        ...
        verify(pageServlet).handleException(hsRequest, hsResponse, "process/processName/processVersion", true, instantiationException);
    ...
    public void should_get_unauthorized_when_engine_session_is_invalid() throws Exception {
        ...
        verify(pageServlet).handleException(hsRequest, hsResponse, "process/processName/processVersion", true, invalidSessionException);
