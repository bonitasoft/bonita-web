...
public interface IItem extends JsonSerializable {
     ...
     *        The value of the Item.
     */
    void setAttribute(final String name, final String value, final boolean applyModifiers, final boolean applyValidators);
     ...
     *        The value of the Item.
     */
    void setAttribute(final String name, final Object value, final boolean applyModifiers, final boolean applyValidators);
     ...
     *        The value of the Item.
     */
    void setAttribute(final String name, final APIID value, final boolean applyModifiers, final boolean applyValidators);
    ...
    void setAttributes(final Map<String, String> attributes, final boolean applyModifiers, final boolean applyValidators);
