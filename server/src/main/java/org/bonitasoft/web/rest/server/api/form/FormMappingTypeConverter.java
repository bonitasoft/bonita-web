 ...
 */
public class FormMappingTypeConverter implements Converter<FormMappingType> {

    @Override
    public FormMappingType convert(String stringValue) throws ConversionException {
        return FormMappingType.valueOf(stringValue);
    }
}
