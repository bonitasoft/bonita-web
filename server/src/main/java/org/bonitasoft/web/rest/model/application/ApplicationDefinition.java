...
public class ApplicationDefinition extends ItemDefinition<ApplicationItem> {
    ...
    protected void defineAttributes() {
        ...
        createAttribute(ApplicationItem.ATTRIBUTE_ICON, ItemAttribute.TYPE.STRING).addValidator(new FileIsImageOrServletPathValidator(ApplicationItem.ICON_PATH_API_PREFIX));
