...
public class APIProcessParameter extends ConsoleAPI<ProcessParameterItem> {
    ...
    public ItemSearchResult<ProcessParameterItem> search(final int page, final int resultsByPage, final String search, final String orders,
        ...
        try {
            ...
            if (processId != -1) {
                parameters = processAPI.getParameterInstances(processId, computeIndex(page, resultsByPage), resultsByPage, ParameterCriterion.valueOf(orders.toUpperCase().replace(" ", "_")));
