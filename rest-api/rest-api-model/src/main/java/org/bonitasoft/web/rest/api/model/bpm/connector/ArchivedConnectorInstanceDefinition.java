 ...
 */
package org.bonitasoft.web.rest.api.model.bpm.connector;
...
public class ArchivedConnectorInstanceDefinition extends ConnectorInstanceDefinition {
    ...
    @Override
    public APICaller<ConnectorInstanceItem> getAPICaller() {
        return new APICaller<ConnectorInstanceItem>(this);
    }
