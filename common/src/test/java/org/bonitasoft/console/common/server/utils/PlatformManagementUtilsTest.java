...
public class PlatformManagementUtilsTest {
    ...
    @Rule
    public TestRule clean = new ClearSystemProperties("org.bonitasoft.platform.username", "org.bonitasoft.platform.password");
    @Rule
    ...
    @Test
    public void should_throw_an_exception_with_comprehensive_message_when_system_property_to_connect_to_the_platform_is_not_set_properly() throws Exception {
        doReturn(false).when(platformManagementUtils).isLocal();
        ...
        expectedException.expectMessage("The portal is not able to login to the engine because system properties org.bonitasoft.platform.username and org.bonitasoft.platform.password are not set correctly");
        platformManagementUtils.platformLogin();
    }
}
