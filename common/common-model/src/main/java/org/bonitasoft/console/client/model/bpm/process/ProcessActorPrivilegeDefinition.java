 ...
 * 
 */
public class ProcessActorPrivilegeDefinition extends ItemDefinition {

    /**
     * Singleton
     */
    public static final ProcessActorPrivilegeDefinition get() {
        return (ProcessActorPrivilegeDefinition) Definitions.get(TOKEN);
    }

    public static final String TOKEN = "processActorRight";

    /**
     * the URL of users resource
     */
    private static final String API_URL = "../API/bpm/actorPrivilege";
    ...
    protected IItem _createItem() {
        return new ProcessActorPrivilegeItem();
    }

    @Override
    public APICaller<ProcessActorPrivilegeItem> getAPICaller() {
        return new APICaller<ProcessActorPrivilegeItem>(this);
    }
