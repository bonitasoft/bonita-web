...
import org.bonitasoft.console.client.model.bpm.AbstractDocumentDefinition;
...
public class CaseDocumentDefinition extends AbstractDocumentDefinition {
    ...
    @Override
    public APICaller<CaseDocumentItem> getAPICaller() {
        return new APICaller<CaseDocumentItem>(this);
    }
